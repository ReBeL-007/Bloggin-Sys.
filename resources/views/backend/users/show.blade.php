              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$user->phone}}</td>
                        <td>
                        <a href="{{ url('admin/user/'.$user->id.'/edit') }}"> <i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                      
                        <form id="delete-form-{{ $user->id }}" action="{{ url('admin/user/'.$user->id)}}" method="post">
                            {{ csrf_field() }}
                            {{ method_field('DELETE') }}
                        </form>
                             <a href="" onclick="
